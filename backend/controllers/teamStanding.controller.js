...
export const getTeamStandingsByTournament = async (req, res) => {
  try {
...
export const createOrUpdateTeamStanding = async (req, res) => {
  try {
...
export const recalculateTournamentStandings = async (req, res) => {
  try {
    const { tournamentId } = req.params;
